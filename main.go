...
import (
	...
	"github.com/andrewbaxter/dinker/dinker"
...
type Args struct {
	...
	Files     []dinker.BuildImageArgsFile `json:"files"`
	Cmd       []string                    `json:"cmd"`
	...
	Ports      []dinker.BuildImageArgsPort `json:"ports"`
...
func main0() error {
			...
			&imagecopy.Options{
				SourceCtx: &types.SystemContext{
					DockerAuthConfig: &types.DockerAuthConfig{
						Username: dinker.Def(args.FromCreds.User, ""),
						Password: dinker.Def(args.FromCreds.Password, ""),
					},
				},
			},
		)
	...
	if err := dinker.BuildImage(dinker.BuildImageArgs{
		FromPath:    args.From,
		Files:       args.Files,
		Cmd:         args.Cmd,
		AddEnv:      args.AddEnv,
	...
	_, err = imagecopy.Image(
		...
		&imagecopy.Options{
			DestinationCtx: &types.SystemContext{
				...
				DockerAuthConfig: &types.DockerAuthConfig{
					Username: dinker.Def(args.DestCreds.User, ""),
					Password: dinker.Def(args.DestCreds.Password, ""),
				},
			},
		},
	)
